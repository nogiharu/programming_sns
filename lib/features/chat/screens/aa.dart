...
class ChatScreenExanple extends StatefulWidget {
  const ChatScreenExanple({Key? key}) : super(key: key);

  @override
  State<ChatScreenExanple> createState() => _ChatScreenState();
}

class _ChatScreenState extends State<ChatScreenExanple> {
