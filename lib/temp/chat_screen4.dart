...
import 'package:programming_sns/temp/chat_user_list_provider.dart';
import 'package:programming_sns/temp/chat_message_list_provider.dart';
...
class ChatScreen4 extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _ChatScreen4State();
}

class _ChatScreen4State extends ConsumerState<ChatScreen4> {
  ...
  late final ChatMessageListNotifier _chatMessageListNotifier =
      ref.read(chatMessageListProvider(widget.chatRoomId).notifier);
    ...
    return Scaffold(
        ...
        body: ref.watchEX(
          ...
          complete: (currentUserModel) {
            ...
            /// CHAT_USER_LIST
            return ref.watchEX(
              chatUserListProvider(widget.chatRoomId),
              complete: (chatUserList) {
                /// EVENT
                ...
                return ref.watchEX(
                  ...
                  complete: (chatMessageList) {
                    _chatController = ChatController(
                      initialMessageList: chatMessageList,
  ...
  Future<void> onSendTap(String message, ReplyMessage replyMessage, MessageType messageType) async {
    ...
    if (_chatController.initialMessageList.length > 100) {
      _chatController.initialMessageList = await _chatMessageListNotifier.getMessages();
    }
  }
  ...
  Future<void> loadMoreData() async {
    ...
    final messageList25Ago = await _chatMessageListNotifier.getMessages(
