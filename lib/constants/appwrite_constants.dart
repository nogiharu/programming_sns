class AppwriteConstants {
  ...
  static const String messageImagesBucket = '65ada7b0d8ff019e2d32';

  static String imageUrl(String imageId) =>
      '$endPoint/storage/buckets/$messageImagesBucket/files/$imageId/view?project=$projectId&mode=admin';
