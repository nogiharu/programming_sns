...
-- COMMENT ON COLUMN public.chat_rooms.member_user_ids IS 'チャットルームのメンバー（ユーザーID配列）';
...
-- CREATE INDEX idx_chat_rooms_member_user_ids ON public.chat_rooms (member_user_ids);
------------------------【トリガーの追加】------------------------
-- 操作を処理するトリガー関数
CREATE
